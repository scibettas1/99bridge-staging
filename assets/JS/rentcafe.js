...
$('#gallery #gallery-image .overlay').prepend('<div class="amenities"><h1>AMENITIES THAT AMAZE</h1><div class="normaltext">Customize your ideal lifestyle through an exciting array of community amenities, dedicated to delivering the perfect live/work/play balance. Abundant indoor and outdoor spaces include social and co-working lounges, state-of-the-art fitness facilities, a kids playroom, pet spa, a sun terrace with an outdoor bar, BBQs, fire pit, a swimming pool, and so much more. With so many carefully considered amenities, getting away from it all is just as easy as stepping outside your door.<br /><br /><br /><a class="btn btn btn-primary" href="photogallery.aspx"><span style="font-size: 21px">View Gallery</span></a></div></div></div>');
...
$('#apt-amenities').append('<div><br /><br /><a class="btn btn btn-primary" href="map.aspx"><span style="font-size: 21px">View Map</span></a></div>');
